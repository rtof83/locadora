...
begin
 ...
 begin
   ...
   if rdbestoque.Checked = true then frmprincipal.rvpLocadora.SetParam('Tipo', 'Disponível em Estoque');
   if rdbgenero.checked  = true then frmprincipal.rvpLocadora.SetParam('Tipo', 'Gênero');
